function plotPoint() {
    ...
    point.style.setProperty('left', (x - x0 + 200 - 5) + 'px'); // subtract half the width of the point to center it by changing left css property
    point.style.setProperty('bottom', (y - y0 + 200 - 5) + 'px'); // subtract half the height of the point to center it by changing bottom css property
